...
<div class="container">
   ...
   <div class="row justify-content-center" id='saveInc'>
		...
		{{ Form::label('sexo_pac', 'Sexo: ',array('class' => 'col-sm-1 col-form-label')) }}
                <div class="col-sm">
                    <div class="custom-control custom-radio custom-control-inline">
                      {{ Form::radio('sexo_pac', 'M', false, array('id'=>'sexo_m','class' => 'custom-control-input','required'=>'required','disabled'=>'disabled')) }}
                      <label class="custom-control-label" for="sexo_m">
                            <span class="fa fa-male"></span>
                        </label>
                    </div>
                      <div class="custom-control custom-radio custom-control-inline">
                        {{ Form::radio('sexo_pac', 'F', false, array('id'=>'sexo_f','class' => 'custom-control-input','required'=>'required','disabled'=>'disabled')) }}
	...
	<div class="form-group row">
		...
		<div class="col-sm">
			{{ Form::select('id_planta',$plantas,null,array('class'=>'form-control','required' => 'required','disabled' => true)) }}
		</div>

		{{ Form::label('id_area', 'Area de la Planta: ',array('class' => 'col-sm col-form-label')) }}
		<div class="col-sm">
			{{ Form::select('id_area',$areas,null,array('class'=>'form-control','required' => 'required','disabled' => true)) }}
		</div>
		...
		<div class="col-sm">
			{{ Form::select('turno_pac', 
					array('' => 'Seleccionar...',
								...
								'T' => 'Tercero',
								'E' => 'Extra'
					),null,array('required'=>'required','id'=>'turno_pac','class'=>'form-control','disabled' => true)) }}
		</div>
	...
	<div class="form-group row">
		{{ Form::label('fecha_accidente', 'Fecha del Accidente: ',array('class' => 'col-sm-2 col-form-label')) }}
                <div class="input-group col-sm">
                  {{ Form::date('fecha_accidente', null,array('class' => 'form-control', 'required' => 'required', 'placeholder' => 'DD/MM/AAAA','readonly'=>'readonly')) }}
        ...
        {{ Form::label('fecha_acude', 'Fecha en que acude: ',array('class' => 'col-sm-2 col-form-label')) }}
                <div class="input-group col-sm">
                  {{ Form::date('fecha_acude', null,array('class' => 'form-control', 'required' => 'required', 'placeholder' => 'DD/MM/AAAA','readonly'=>'readonly')) }}
                  <div class="input-group-prepend">
                    <span class="input-group-text fas fa-calendar" id="inputGroupPrepend2"></span>
                  </div>
                </div>
		...
		<div class="col-sm">
			{{ Form::select('atendio_pac', 
					array('' => 'Seleccionar...',
								...
								'IMSS' => 'Seguro Social',
								'AMC' => 'AMC',
					),null,array('required'=>'required','id'=>'atendio_pac','class'=>'form-control','disabled' => true)) }}
		</div>
		...
		<div class="col-sm">
			{{ Form::select('tipo_riesgo_acc', 
					...
					),null,array('required'=>'required','id'=>'tipo_riesgo','class'=>'form-control','disabled' => true)) }}
		</div>

		{{ Form::label('supervisor_pac', 'Supervisor:',array('class' => 'col-sm-1 col-form-label')) }}
                
        <div class="col-sm">
            {{ Form::text('supervisor_pac', null, array('class' => 'form-control', 'required' => 'required', 'placeholder' => 'Supervisor','maxlength'=>'70','readonly'=>'readonly')) }}
        </div>
	...
	<div class="form-group row">
		...
		<div class="col-sm">
			{{ Form::select('id_parte_cuerpo',$partBody,null,array('class'=>'form-control','required' => 'required','disabled' => true)) }}
		</div>

		{{ Form::label('id_diagn', 'Diagnóstico: ',array('class' => 'col-sm-1 col-form-label')) }}
		<div class="col-sm">
			{{ Form::select('id_diagn',$diagnosticos,null,array('class'=>'form-control','required' => 'required','disabled' => true)) }}
		</div>
	</div>
	...
	{{ Form::label('observaciones_diag', 'Observaciones del diagnostico: ',array('class' => 'col-sm-3 col-form-label')) }}           
        <div class="col-sm">
            {{ Form::text('observacion_diag', null, array('class' => 'form-control', 'required' => 'required', 'placeholder' => 'Comentarios adicionales...','maxlength'=>'200','readonly'=>'readonly')) }}
        </div>
	</div>
	...
	{{ Form::label('observaciones_acc', 'Observaciones Generales: ',array('class' => 'col-sm-3 col-form-label')) }}           
        <div class="col-sm">
            {{ Form::text('observaciones_acc', null, array('class' => 'form-control', 'required' => 'required', 'placeholder' => 'Comentarios adicionales...','maxlength'=>'200','readonly'=>'readonly')) }}
        </div>
	</div>
	...
	<div class="form-group row">
		{{ Form::label('incapacidad_aplica', 'Aplica incapacidad:',array('class' => 'col-sm-2 col-form-label')) }}
                <div class="col-sm-2">
                    <div class="custom-control custom-radio custom-control-inline">
                      {{ Form::radio('incapacidad_aplica', 'S', false, array('id'=>'aplica_s','class' => 'custom-control-input','required'=>'required','disabled'=>'disabled')) }}
                      <label class="custom-control-label" for="aplica_s">
                            <span class="fa fa-check-circle"></span>
                        </label>
                    </div>
                      <div class="custom-control custom-radio custom-control-inline">
                        {{ Form::radio('incapacidad_aplica', 'N', false, array('id'=>'aplica_n','class' => 'custom-control-input','required'=>'required','disabled'=>'disabled')) }}
             ...
             @endphp
                ...
                <div class="input-group col-sm">
                  {{ Form::date('fecha_inicio_inc', null,array('class' => 'form-control', 'placeholder' => 'DD/MM/AAAA','readonly'=>'readonly')) }}
                  <div class="input-group-prepend">
                    <span class="input-group-text fas fa-calendar" id="inputGroupPrepend2"></span>
                  </div>
                </div>
...
$('#btnActivar').on('click', function(e) {
    ...
    @if(isset($incapacidad))
      if(confirm("¿Deseas volver a activar el Accidente?")){
         $.ajaxSetup({
      ...
      headers: {
        ...
        $.ajax({
            ...
            data: {
                    'incapacidad' : '{{ $incapacidad->id_incapacidad }}',
                    'band' : 'A'
                   },
         ...
         $.ajax({
            method: 'POST', // Type of response and matches what we said in the route
            url: '/accidentes/regresar', // This is the url we gave in the route
            data: {
                    'accidente' : '{{ $incapacidad->id_incapacidad }}',
                    'band' : 'A'
                   },
            success: function(response){ // What to do if we succeed
                console.log(response); 
                window.location.href = "http://contitech.com/accidentes/{{ $accidente->id_accidente }}/edit";
            },
            error: function(jqXHR, textStatus, errorThrown) {
                console.log('error'); // What to do if we fail
                console.log(JSON.stringify(jqXHR));
